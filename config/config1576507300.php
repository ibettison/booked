...
$conf['settings']['admin.email'] = 'ian.bettison@ncl.ac.uk';         // email address of admin user
$conf['settings']['admin.email.name'] = 'Ian Bettison';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['database']['user'] = 'bookedscheduler_user';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'U0wftw0wcaw!';
 ...
 */
$conf['settings']['install.password'] = 'U0wftw0wcaw!';
/**
 * Pages
 */
